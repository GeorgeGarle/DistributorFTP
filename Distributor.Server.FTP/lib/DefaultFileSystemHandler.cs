...
namespace Distributor.Server.FTP.lib
{
    /// <summary>
    ...
    public class DefaultFileSystemHandler : IFileSystemHandler
    {
        ...
        // Hardcoded for the moment to look in folder _root
        private static string _rootPath = "\\_root\\";
        ...
        public DefaultFileSystemHandler(string startPath)
        {
            ...
            this.currentPath = $"{startPath}{_rootPath}";
        }

        public DefaultFileSystemHandler() : this(Directory.GetCurrentDirectory())
        {
        }
        ...
        public ResultOrError<string> DirSearch(string path)
        {
            string newPath = "";
            try
            {
        ...
        public ResultOrError<FileSystemEntry[]> ListEntries(string path)
        {
            ...
            //realPath = Directory.GetCurrentDirectory() + $@"\{path}\";
        ...
        {
            return FileSystemHelper.ReturnPath(currentPath, path);
        ...
        private string DecodePath(string path)
        {
            ...
            if (os == OS.WinNT)
            {
                ...
                if (path[1] == '/')
                    return path.Substring(0).Remove(0, 1);
